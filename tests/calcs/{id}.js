...
Test('/calcs/{id}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         * responses: 200, 404
         */
        t.test('test getCalcsById get operation', function (t) {
            Mockgen().requests({
                path: '/calcs/{id}',
                operation: 'get'
            }, function (err, mock) {
         ...
         * responses: 200, 500
         */
        t.test('test putCalcById put operation', function (t) {
            Mockgen().requests({
                path: '/calcs/{id}',
                operation: 'put'
            }, function (err, mock) {
         ...
         * responses: 204, 404
         */
        t.test('test deleteCalcsById delete operation', function (t) {
            Mockgen().requests({
                path: '/calcs/{id}',
                operation: 'delete'
            }, function (err, mock) {
         ...
         * responses: 200, 500
         */
        t.test('test patchCalcsById patch operation', function (t) {
            Mockgen().requests({
                path: '/calcs/{id}',
                operation: 'patch'
            }, function (err, mock) {
